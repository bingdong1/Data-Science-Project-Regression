...
#load data
air_stores <- read.csv("air_store_info.csv", stringsAsFactors = FALSE,
                    encoding="UTF-8")
## problems with some accents, change it
air_stores$air_area_name <- stri_trans_general(air_stores$air_area_name,"Latin-ASCII")


air_visits <- read.csv("air_visit_data.csv",  stringsAsFactors = FALSE,
                    encoding="UTF-8")
air_reserve <- read.csv("air_reserve.csv",  stringsAsFactors = FALSE,
                     encoding="UTF-8")
hpg_reserve <- read.csv("hpg_reserve.csv",  stringsAsFactors = FALSE,
                     encoding="UTF-8")
str(hpg_reserve)
hpg_stores <- read.csv("hpg_store_info.csv", stringsAsFactors = FALSE,
                    encoding="UTF-8")
hpg_stores$hpg_area_name <- stri_trans_general(hpg_stores$hpg_area_name,"Latin-ASCII")

store_mapping <- read.csv("store_id_relation.csv", stringsAsFactors = FALSE,
                       encoding="UTF-8")
holidays <- read.csv("date_info.csv", stringsAsFactors = FALSE,
                  encoding="UTF-8")
#End of load data
